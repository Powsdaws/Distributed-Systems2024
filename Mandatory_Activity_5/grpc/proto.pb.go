...
type Outcome struct {
	...
	WinnerId   uint32 `protobuf:"varint,1,opt,name=winner_id,json=winnerId,proto3" json:"winner_id,omitempty"` //this is left blank if the auction is not over
...
func (x *Outcome) GetWinnerId() uint32 {
	if x != nil {
		return x.WinnerId
	}
	return 0
...
type Ack struct {
	...
	Acknowledgement bool `protobuf:"varint,1,opt,name=acknowledgement,proto3" json:"acknowledgement,omitempty"`
}
...
func (x *Ack) GetAcknowledgement() bool {
	if x != nil {
...
var file_grpc_proto_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x3a, 0x0a, 0x03, 0x42, 0x69, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x63, 0x6c, 0x69,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x07,
	0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x22, 0x47, 0x0a, 0x07, 0x4f, 0x75, 0x74, 0x63, 0x6f,
	0x6d, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x77, 0x69, 0x6e, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x08, 0x77, 0x69, 0x6e, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x12,
	...
	,
...
var file_grpc_proto_proto_depIdxs = []int32{
	0, // 0: AuctionService.bid:input_type -> Bid
	1, // 1: AuctionService.result:input_type -> Empty
	3, // 2: AuctionService.bid:output_type -> Ack
	2, // 3: AuctionService.result:output_type -> Outcome
